...
t_venues = sa.Table('venues', metadata,
	...
	sa.Column('name', pg.TEXT, key=u'name', doc=''),
	...
	sa.Column('city', pg.TEXT, key=u'city', doc=''),
	sa.Column('state', pg.TEXT, key=u'state', doc=''),
	sa.Column('country', pg.TEXT, key=u'country', doc=''),
